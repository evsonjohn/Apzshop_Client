...
require_once ("class_vendor/vendor_connection.php");
...
if(isset($_GET['message']) && $_GET['message'] == 'redirected') {
    ...
    echo '<div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">';
    ...
    // Output JavaScript to trigger modal display
    echo '<script>';
    echo '    $(document).ready(function() {';
    echo '        $("#successModal").modal("show");';
    echo '    });';
    echo '</script>';
  }elseif(isset($_GET['message']) == 'add_tocart'){//after add to cart
    echo '<div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">';
    echo '    <div class="modal-dialog">';
    echo '        <div class="modal-content">';
    echo '            <div class="modal-header">';
    ...
    echo '            </div>';
    echo '            <div class="modal-body">';
    echo '                successfully add to your cart.';
    echo '            </div>';
          ...
          <div class="col-md-12">
            <div class="category-carousel swiper mt-0">
              <div class="swiper-wrapper">
                <a href="Shop/category.php?id=1" class="nav-link category-item swiper-slide">
                  <img src="images/clothes.png" alt="Category Thumbnail">
                  <h3 class="category-title">Clothes</h3>
                </a>
                <a href="Shop/category.php?id=2" class="nav-link category-item swiper-slide">
                  <img src="images/shoes.png" alt="Category Thumbnail">
                  <h3 class="category-title">Shoes</h3>
                </a>
                <a href="Shop/category.php?id=3" class="nav-link category-item swiper-slide">
                  <img src="images/gadgets.png" alt="Category Thumbnail">
                  <h3 class="category-title">Gadgets</h3>
                </a>
                <a href="Shop/category.php?id=4" class="nav-link category-item swiper-slide">
                  <img src="images/appliances.png" alt="Category Thumbnail">
                  <h3 class="category-title">Appliances</h3>
                </a>
                <a href="Shop/category.php?id=5" class="nav-link category-item swiper-slide">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Meat</h3>
                </a>                
              </div>
            </div>
          </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <p>Introducing our refreshing Tropical Bliss Smoothie! Dive into a paradise</p>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <p>Experience the classic taste of Heinz Tomato Ketchup, the timeless condiment loved by generations.</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop Collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
            ...
            <div class="bootstrap-tabs product-tabs">
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                foreach ($categories as $Categories){
                  ...
                  $stmt = "SELECT * FROM `vendor_product` WHERE `product_category`='$Categories' AND `status`='approve'";
                  $db = $conn->prepare($stmt);
                  $db->execute();
                  $rowcount = $db->rowCount();

                  $stmt1 = "SELECT * FROM `product_img` WHERE `product_id`='$Categories'";
                  $db1 = $conn->prepare($stmt1);
                  $db1->execute();
                  $rowcount1 = $db1->rowCount();
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                          <?php while($product_img = $db1->fetch()){ ?>
                      <figure>
                        <a href="Shop/single_product.php?id=<?php echo $product['product_id']; ?>" title="Product Title">
                          <img src="images/product_pictures/<?php echo $product_img['1st_img']; ?>" alt="Product Thumbnail" class="tab-image">
                        </a>
                      </figure>
                      <?php }?>
                      <h3><?php echo $product['product_name']; ?></h3>
                      <span class="qty"><?php echo "Stock:".$product['product_stock']; ?></span>
                      
                      <div class="rating-container d-flex gap-0 align-items-center">
                <div class="rating-container d-flex gap-0 align-items-center">

                    <?php for ($i = 1; $i <= 5; $i++): //product rating
                      $product_rating = computeProductRating($product['product_id']); ?>
                    ...
                    <span class="rating-count"><?php echo "($product_rating)"; ?></span>
                      ...
                      <span class="price"><?php echo "Price:".$product['product_price']; ?></span>
                      <div class="d-flex align-items-center justify-content-between">
                          ...
                          <a href="Shop/single_product.php?id=<?php echo $product['product_id']; ?>" class="nav-link">Add to Cart <svg width="18" height="18"><use xlink:href="#cart"></use></svg></a>
                        </div>
                      </div>
                    </div>
                <?php 
          ...
          <div class="container my-5">
            <div class="row">
              <div class="col-md-6 p-5">
                ...
                <p>Unlock a sensational offer: Enjoy an exclusive 25% discount on your inaugural purchase! Dive into a world of savings and savor our premium products at an irresistible price. </p>
              </div>
              <div class="col-md-6 p-5">
                <form>
                  <div class="mb-3">
        ...
        <div class="bg-warning py-5 rounded-5" style="background: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-8">
                <h2 class="my-5">Shop faster with Apz Shop App</h2>
                <p>Accelerate your shopping experience with the Apz Shop App! Say goodbye to long queues and hello to seamless browsing at your fingertips.</p>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    ...
                    <p class="card-text">Money back</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div class="card mb-3 border-0">
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    <h5>Daily offers</h5>
                    <p class="card-text">Get Voucher!</p>
                  </div>
                </div>
              </div>
              </div>
