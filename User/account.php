...
$address_id = address_id_1($userSession['id']);//fetch user address1 ID
$address_id2 = address_id_2($userSession['id']);//fetch user address2 ID
?>
...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="dropdown-menu p-3 mx-2" aria-labelledby="profileDropdown">
                      ...
                      <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                          <a href="account.php" class="text-body ms-0">
                            <i class="me-2 icon-md" data-feather="user"></i>
                            <span>Profile</span>
                          </a>
                        </li>
                        <li class="dropdown-item py-2">
                          <a href="edit_info.php" class="text-body ms-0">
                            <i class="me-2 icon-md" data-feather="edit"></i>
                            <span>Edit Profile</span>
                          </a>
                        </li>
                        <li class="dropdown-item py-2">
                          <a href="log_out.php" class="text-body ms-0">
    ...
    <?php  insert_image($userSession['id']); ?>
    <?php
      if(isset($_GET['error'])){
      ...
      ?>
    <div class="container rounded bg-white mt-7 mb-3">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="wd-50 ht-5 rounded-circle smaller-profile-image2" src="../images/<?php echo $user_Data['buyer_image']; ?>" alt="profile">
                    <form action="" method="post" autocomplete="off" enctype="multipart/form-data"> 
                        <input type="file" id="image" name="image" accept=".jpg, .jpeg, .png" class="form-control form-control-sm border-dark">
                        &nbsp;
                        <input type="submit" class="btn btn-outline-success btn-sm" name="add_photo" value="Add Photo">
                    </form>
                <span class="font-weight-bold text-dark"><?php echo $user_Data['first_name']." ".$user_Data['last_name']?></span>
                <span class="text-dark"><?php echo $user_Data['email'];?></span>
                <br>
                <a class="btn btn-outline-primary btn-sm" href="password_reset.php" role="button">Change Password</a>&nbsp;
                <a class="btn btn-outline-success btn-sm" href="edit_info.php" role="button">Edit Info</a>
            </div>
        </div>
        ...
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><p class="text-dark"><?php echo $user_Data['first_name'];?></p></div>
                    <div class="col-md-6"><label class="labels">Lastname</label><p class="text-dark"><?php echo $user_Data['last_name'];?></p></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <p class="text-dark">
                            ...
                            <a class="btn btn-outline-success btn-sm" href="edit_address.html" role="button">Change Email</a>
                        </p>
                    </div>
                    <div class="col-md-12">
                        ...
                        <p class="text-dark">
                          ...
                          <div class="col-md-12"><label class="labels">Age</label><p class="text-dark"><?php echo $user_Data['age'];?></p></div>
                          <div class="col-md-12"><label class="labels">Birthday</label><p class="text-dark"><?php echo $user_Data['birthday'];?></p></div>
                          <div class="col-md-12"><label class="labels">Gender</label><p class="text-dark"><?php echo $user_Data['gender'];?></p></div>

                          <div class="col-md-12"><label class="labels">Address 1</label><p class="text-dark"><?php echo $address_id['street']." ".$address_id['barangay']."".$address_id['city']."".$address_id['province']; ?>
                          <a class="btn btn-outline-success btn-sm" href="edit_address_1.php" role="button">Add/Edit</a>
                          <a class="btn btn-outline-danger btn-sm" href="#" role="button">delete</a></div></p>

                          <div class="col-md-12"><label class="labels">Address 2</label><p class="text-dark"><?php echo $address_id2['street']." ".$address_id2['barangay']."".$address_id2['city']."".$address_id2['province']; ?>
                            <a class="btn btn-outline-success btn-sm" href="edit_address_2.php" role="button">Add/Edit</a>
                            <a class="btn btn-outline-danger btn-sm" href="#" role="button">delete</a></div></p>
                        </div>
                  </div>
              </div>
