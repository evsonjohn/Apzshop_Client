...
<html lang="en">
  ...
  <body>
    ...
    <div class="success-container">
         <p class="success-message" ><?php user_address_1();//insert user address ?></p> 
        </div>
        <style>
      .success-container {
        ...
        <div class="col-md-3 border-right">
          <div class="form-group">
            <form action="" method="post">
              <label for="autocomplete" class="text-dark">Street</label>
              <input type="hidden" name="address_id" value="<?php echo $address_id['address_id'];?>">
              <input type="hidden" name="user_id" value="<?php echo $user_Data['buyer_id'];?>">
              <input type="text"
                     name="street"
                     class="form-control" 
                     id="autocomplete" 
                     placeholder="Street"
                     value="<?php echo $address_id['street'];?>">
    
              <label for="inputbarangay" class="text-dark">Barangay</label>
              <input type="text"
                     name="barangay" 
                     class="form-control" 
                     id="inputbarangay" 
                     placeholder="Barangay"
                     value="<?php echo $address_id['barangay'];?>">
              ...
              <input type="text"
                     ...
                     id="inputCity" 
                     placeholder="City"
                     value="<?php echo $address_id['city'];?>">
              ...
              <input type="text"
                     ...
                     id="inputZip" 
                     placeholder="Zip"
                     value="<?php echo $address_id['zip_code'];?>">
    
              <label for="inputProvince" class="text-dark">Province</label>
              <input type="text"
                     name="province" 
                     class="form-control" 
                     id="inputProvince" 
                     placeholder="Province"
                     value="<?php echo $address_id['province'];?>">
    
              <input type="submit" name="Add" class="btn btn-outline-success btn-sm" value="Add">
              <a href="auto_detectLocation/map.php" class="btn btn-outline-info btn-sm" onclick="detectLocation()">Detect your location</a>
    ...
    <style>
      ...
      .form-control::placeholder {
        color: white; /* Set placeholder color */
      }
    </style>
