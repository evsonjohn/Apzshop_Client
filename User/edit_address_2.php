...
$address_id = address_id_2($userSession['id']);//fetch user address2 ID
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="success-container">
         <p class="success-message"><?php user_address_2(); ?></p> 
        </div>
    <style>
      .success-container {
        ...
        <div class="col-md-3 border-right">
          <div class="form-group">
            ...
            <label for="autocomplete" class="text-dark">Street</label>
              ...
              <input type="submit" name="" class="btn btn-outline-info btn-sm" value="Detect your location">
            </form>
          </div>
        </div>
      </div>
    ...
    <style>
      ...
      .form-control::placeholder {
        color: #b3b3b3; /* Set placeholder color */
      }
    </style>
