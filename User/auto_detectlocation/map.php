...
<html lang="en">
  ...
  <body>
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                ...
                <input type="hidden" name="prdid" value="<?php echo $view_carts['product_id'];?>" > 
              </div>
              <div>
    ...
    <div class="success-container">
         <!-- <p class="success-message"><?php //user_address_1(); ?></p>  -->
        </div>

  <style>
  input {
    margin-bottom: 0px; /* Increase or decrease as needed */
  }
  
  label {
    margin-top: 0px; /* Increase or decrease as needed */
  }
...
<div class="form-group">
  <form id="locationForm">
    ...
    <input type="text" id="road" name="road" class="form-control" readonly><br>

    <label for="quarter">Barangay:</label>
    <input type="text" id="quarter" name="quarter" class="form-control" readonly><br>

    <label for="city">City:</label>
    <input type="text" id="city" name="city" class="form-control" readonly><br>

    <label for="neighbourhood">Neighbourhood:</label>
    <input type="text" id="neighbourhood" name="neighbourhood" class="form-control" readonly><br>

    <label for="postcode">Postcode:</label>
    <input type="text" id="postcode" name="postcode" class="form-control" readonly><br>

    <label for="region">State:</label>
    <input type="text" id="region" name="region" class="form-control" readonly><br>

    <label for="state_district">State District:</label>
    <input type="text" id="state_district" name="state_district" class="form-control" readonly><br>

    <label for="country">Country:</label>
    <input type="text" id="country" name="country" class="form-control" readonly><br>
    
    <input type="hidden" name="user_id" value="<?php echo $userSession['access']; ?>">

    <input type="submit" value="Submit" class="btn btn-outline-success btn-sm">
    <a href="#" class="btn btn-outline-info btn-sm" onclick="detectLocation()">Detect your location</a>
  </form>
</div>
