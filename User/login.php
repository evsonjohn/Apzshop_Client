    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
                <img src="../images/apz_logo.png" class="img-fluid" alt="Sample image">
            </div>
                ...
                <form action="" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="form-check mb-0">
                            <input class="form-check-input-dark me-2" type="checkbox" value=""
                                id="form2Example3" />
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a
                                href="registration.php" class="link-primary">Register</a></p>
                    </div>
                    <?php 
                      login();
                      ?>
...
<script>
    function validateForm() {
        ...
        // Regular expressions to match special characters
        var specialChars = /[!@#$%^&*(),.?":{}|<>]/;
