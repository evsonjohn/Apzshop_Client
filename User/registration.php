        ...
        <form action="" method="post" name="signupForm" id="signupForm">
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="hidden" name="user_profile_picture" value="display_profile_photo.png">
            ...
            <span class="details">Phone Number</span>
              <input type="tel" placeholder="Enter your Phone number" name="P_number" required>
            </div>
    ...
    <script>
        ...
        function validatePassword() {
            ...
            if (!passwordRegex.test(password.value)) {
                password.setCustomValidity("Password must be at least 8 characters long and contain letters and numbers only.");
                return false;
            } else {
