...
<html lang="en">
  ...
  <body>
    ...
    <div class="success-container">
         <p class="success-message"><?php userEdit_info(); ?></p> 
        </div>
    <style>
      .success-container {
        ...
        <form action="" method="post">
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="hidden" name="id" value="<?php echo $user_Data['buyer_id'];?>">
              <input type="text" placeholder="Enter your First name" name="firstname" value="<?php echo $user_Data['first_name'];?>" required>
            </div>
            <div class="input-box">
              <span class="details">Last Name</span>
              <input type="text" placeholder="Enter your Last name" name="lastname" value="<?php echo $user_Data['last_name'];?>" required>
            </div>
            
            <div class="input-box">
              <span class="details">Birthday</span>
              <input type="date" placeholder="Enter your birthday" name="birthday" value="<?php echo $user_Data['birthday'];?>" required>
            </div>
            <div class="input-box">
              <span class="details">Age</span>
              <input type="number" placeholder="Age" name="age" value="<?php echo $user_Data['age'];?>" required>
            </div>
            <div class="input-box">
              <span class="details">Phone number</span>
              <input type="tel" placeholder="Phone Number" name="phone_number" value="<?php echo $user_Data['phone_number'];?>" required>
            </div>
          </div>
