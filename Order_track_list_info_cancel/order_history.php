  ...
  <section class="py-3 mb-3" style="background: url(../images/background-pattern.jpg);">
    <div class="container-fluid">
      <div class="d-flex justify-content-between">
        <h1 class="page-title pb-2">Order History</h1>
        ...
        <div class="col-md-9">
          ...
          <div class="table-responsive cart">
            <table class="table">
              ...
              <?php 
              $user_order = order_list($userSession['id']);
              foreach($user_order as $user_orders){?>
              <tbody>
              <?php if($user_orders['order_status']== 4||$user_orders['order_status']== 5||$user_orders['order_status']== 7){ ?>
                <tr>
                  ...
                  <td scope="row" class="py-4">
                    <div class="input-group product-qty">
                      ...
                      <p class="text-dark"><?php if($user_orders['order_status']== 7){
                        echo "Pending Cancel"; }elseif($user_orders['order_status']== 4){ echo "Order Cancel";}
                        elseif($user_orders['order_status']== 5){ echo "Order Recieved";} ?></p>
