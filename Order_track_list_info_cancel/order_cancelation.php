  ...
  ?>
    ...
    <form id="cancel-form" action="" method="post">
        ...
        <select id="reason" name="reason">
          ...
          <option value="received_defective">Received Defective Item</option>
...
<?php if(isset($_POST['cancel_order'])){
    if(order_cancelationreason($_POST['order_id'],$_POST['reason']) && cancel_order() &&
     cancel_order_vendor($_POST['order_id'],$_POST['reason']) && cancel_order_V() == true){//for order cancelation
