  ...
  <body>
    ...
    <section class="py-2 mb-2" style="background: url(../images/background-pattern.jpg);">
      <div class="container-fluid">
        <div class="d-flex justify-content-between">
          <h1 class="page-title pb-2">Track Order</h1>
        </div>
      </div>
    </section>
    <?php $order_id = $_GET['track_order']; 
    $order_info = order_info_vendor($order_id);

    $product_img = products_img($order_info['product_id']);

    $vendor_info = vendor_info($order_info['product_id']);
    ...
    <div class="container">
      <article class="card">
          ...
          <div class="card-body">
              <h6>Order ID: <?php echo $order_info['order_id']; ?></h6>
              <article class="card">
                  <div class="card-body row">
                      <div class="col"> <strong>Estimated Delivery time:</strong> <br>
                    <?php //estimated time of delvery
                    ...
                    if ($result->rowCount() > 0) {
                        ...
                        $estimatedDeliveryDate = calculateEstimatedDelivery($startDate, $days);
                          ...
                          echo '<span style="font-size: 18px;">' . $estimatedDeliveryDate . '</span>';
                          echo '</div>';

                    } else {
                        echo "No results found.";
                    }?></div>
                      <div class="col"> <strong>Shipping BY:</strong> <br> <?php echo $vendor_info['f_vendor']." ".$vendor_info['l_vendor']; ?>, <br> <i class="fa fa-phone"></i> <?php echo $vendor_info['phone_n']; ?> </div>
                      <div class="col"> <strong>Status:</strong> <br> 
                        <?php if($order_info['order_status']== 1){
                        echo "Seller Preparing"; }elseif($order_info['order_status']== 2){ echo "Order Shipped";}
                        elseif($order_info['order_status_id']== 3){ echo "On Delivery";}
                        elseif($order_info['order_status_id']== 7){ echo "Order Recieved";} ?></div>
              ...
              <div class="track">
                <?php if($order_info['order_status']== 1){ ?>
                  ...
                  <div class="step"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Order Ship</span> </div>
                ...
                <?php }elseif ($order_info['order_status']== 2){ ?>
                  <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pending Order</span> </div>
                  <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Order Ship</span> </div>
                  <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> On Delivery </span> </div>
                  <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Order Received</span> </div>
                <?php }elseif($order_info['order_status']== 3){?>
                  ...
                  <div class=""> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Order Received</span> </div>
              ...
              <ul class="row">
                  <li class="col-md-4">
                      <figure class="itemside mb-3">
                          <div class="aside"><img src="../images/product_pictures/<?php echo $product_img['1st_img']; ?>" class="img-sm border"></div>
                          <figcaption class="info align-self-center">
                              <p class="title">Product: <?php echo $order_info['product_name']; ?></p> <span class="text-muted">Price:<?php echo $order_info['price']; ?> </span>
                          </figcaption>
                      </figure>
                  </li>
                  <?php if ($order_info['order_status']== 3 || $order_info['order_status']== 4){ ?>
                  <li class="col-md-4">
                      <figure class="itemside mb-3">
                          
                          <figcaption class="info align-self-center">
                              <p class="title">Driver:Jerick Montuya <br> Number:09542274112</p> <span class="text-muted">Courier: J&T</span>
                          </figcaption>
                      </figure>
                  </li>
                  <?php } ?>
              ...
              <hr>
              <a href="order_list.php" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i> Back to orders</a>
          </div>
      </article>
  </div>
