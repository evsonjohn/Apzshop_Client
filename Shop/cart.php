...
<body>
            ...
            <div class="cart text-end d-none d-lg-block dropdown mb-4 ">
              <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                ...
                if(isset($_SESSION['buyer1'])){
                  $cart = count_cart($userSession['id']);//count cart
                  echo "Your cart: ".$cart;}
        ...
        <div class="col-md-8">
          ...
          <div class="table-responsive cart">
            <table class="table">
              ...
              <?php
              $user_carts = user_cart($userSession['id']);
                ...
                <tr>
                    ...
                    <div class="cart-info d-flex flex-wrap align-items-center mb-4">
                      <div class="col-lg-3">
                        <div class="card-image">
                          <input type="hidden" name="cart_id" value="<?php echo $user_cart['cart_id']; ?>">
                          <input type="hidden" name="prd_id" value="<?php echo $user_cart['product_id']; ?>">
                          <img src="../images/product_pictures/<?php echo $user_cart['product_picture']; ?>" alt="cloth" class="img-fluid">
                        </div>
                      </div>
                      <div class="col-lg-9">
                        <div class="card-detail ps-3">
                          <h5 class="card-title">
                            <a href="#" class="text-decoration-none"><?php echo $user_cart['product_name']; ?></a>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  <td class="py-5">
                    <div class="input-group product-qty w-50">
                      <?php echo $user_cart['quantity']; ?>
                    </div>
                  </td>
                  <?php $total = $user_cart['price'] * $user_cart['quantity']  ?>
                  <td class="py-5">
                    <div class="total-price">
                      <span class="money text-dark"><?php echo "₱".$total; ?></span>
                    </div>
                  </td>
                  <td class="py-5">
                  <button type="submit" name="delete_cart" class="icon-button">
                  ...
                  <td class="py-5">
                      <button type="submit" name="checkout_cart" class="btn custom-btn">Checkout</button>
                  </td>
                </tr>
                </form>
                <?php } ?>
  ...
  <style>
    .icon-button {
      ...
      .icon-button svg {
        fill: currentColor; /* This will make the SVG inherit the color of the button */
        width: 24px;
        height: 24px;
      }

/* You can add additional styles for button hover, active, focus states if needed */

  .custom-btn {
    background-color: #FFC43F;
    color: #343a40; /* Dark text color */
    border-color: #FFC43F; /* Matching border color for consistency */
    }

    .custom-btn:hover,
    .custom-btn:focus {
        background-color: #FFC43F; /* Hover and focus color for better user feedback */
        color: #343a40; /* Dark text color */
        border-color: #FFC43F; /* Matching border color for consistency */
    }
    </style>
