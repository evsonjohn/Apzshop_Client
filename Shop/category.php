...
<html lang="en">
  ...
  <body>
    ...
    <section class="py-2 mb-5" style="background: url(../images/background-pattern.jpg);">
      <div class="container-fluid">
        <div class="d-flex justify-content-between">
          <h1 class="page-title pb-2"><?php if(isset($_GET['id'])){
          if($_GET['id']==1){
              echo "Clothes";
                }else if($_GET['id']==2){
                  echo "Shoes";
    ...
    <div class="shopify-grid">
      <div class="container-fluid">
        <div class="row g-5">
          ...
          <?php
             $id = $_GET['id'];
             $product = products($id);//display product
            ...
            <div class="product-grid row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <?php $product_imgs = display_img($products['product_id']);//display product image 
                   foreach($product_imgs as $product_img) { ?>
                  <figure>
                    <a href="single_product.php?id=<?php echo $product_img['product_id']; ?>" title="Product Title">
                      <img src="../images/product_pictures/<?php echo $product_img['1st_img']; ?>"  class="tab-image">
                    </a>
                  </figure>
                  <?php }?>
                  <h3><?php echo $products['product_name']; ?></h3>
                  <span class="qty"><?php echo "Stock:".$products['product_stock']; ?></span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                  <span class="price"><?php echo "Price:".$products['product_price']; ?></span>
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="single_product.php?id=<?php echo $product_img['product_id']; ?>" class="nav-link">Add to Cart <svg width="24" height="24"><use xlink:href="#cart"></use></svg></a>
                  </div>
                </div>
              </div>
            </div>
