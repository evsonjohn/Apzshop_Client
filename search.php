...
<!-- baguhin mo yung rating nung sa product mo sa search at category yun nalang kuolang mo tol hahaha -->
...
?>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <form id="search-form" action="" method="post" class="d-flex mt-3 gap-0">
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="search-bar row bg-light mt-3 rounded-4 pb-3 pt-2 p-3">
            <div class="order-md-last">
              <form role="search" action="" method="post" class="d-flex mt-2 gap-0 ">
    ...
    if(isset($_POST['submit_search'])){
      $prd_name = $_POST['search_prd'];

      $prd_info =  search_prd($prd_name);// display product info
      if ($prd_info !== null) {
      ?>
      <div class="product-grid row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
                  ...
                  <div class="col">
                    <div class="product-item">
                      ...
                      <?php $product_imgs = products_img($prd_info['product_id']);//display product images?>
                       
                      <figure>
                        <a href="Shop/single_product.php?id=<?php echo $product_imgs['product_id']; ?>" title="Product Title">
                          <img src="images/product_pictures/<?php echo $product_imgs['1st_img']; ?>"  class="tab-image">
                        </a>
                      </figure>
                      
                      <h3><?php echo $prd_info['product_name']; ?></h3>
                      <span class="qty"><?php echo "Stock:".$prd_info['product_stock']; ?></span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                      <span class="price"><?php echo "Price:".$prd_info['product_price']; ?></span>
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="input-group product-qty">
                            ...
                            <input type="text" id="quantity" name="quantity" class="form-control quantity input-number" value="1" min="1" max="100">
                            <span class="input-group-btn">
                        ...
                        <a href="single_product.php?id=<?php echo $product_imgs['product_id']; ?>" class="nav-link">Add to Cart <svg width="24" height="24"><use xlink:href="#cart"></use></svg></a>
                      </div>
                    </div>
                  </div>
                </div>
